...
class TestMockFrontEnd(TestCase):
    ...
    def test_incorrect_email(self, mock_inputs):
        ...
        self.assertEqual(result,'Error creating account: Your email address has NOT been given in the requested format')
...
class TestRunFunction(TestCase):
    ...
    def test_incorrect_email(self,mock_inputs):
        result = run()
        self.assertEqual(result,'Issue: Error creating account: Your email address has NOT been given in the requested format' )
    ...
    def test_creating_user2(self,mock_inputs):
        result = run()
        self.assertEqual(result, 'Issue: User details already exist, try again with a new username')
