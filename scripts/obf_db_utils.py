...
#I remember that I did this by id's because the intersect function couldnt work with
# all the dictionaries. so it does the intersection between Id's and then the result is what you use to get the products 
    """ This function takes an ingredient and searches through the products_table
...
def store_results(list_of_products):
    """
    This takes the list of product dictionaries, maps them into a list of records 
    coverts that list to a string eg  [ (45, 2719412, The Grandpa Soap, sodium cocoate/sodium palm kernelate), 
                                        ()
                                       ]
    """
    pass 
